                        ...
                        <div class="row g-4">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            @foreach ($images as $image)
                                                <div>
                                                    <img src="{{ asset('/assets/images/product/main-pic') }}/{{$image }}"
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="price-detail">Rp. {{ number_format($product->price, 0, ' ', '.') }}</h3>
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{ route('shop.product.detail', ['slug'=>$rproduct->slug]) }}">
                                            <img src="{{ asset('/assets/images/product/main-pic') }}/{{ $rproduct->image }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="{{ route('shop.product.detail', ['slug'=>$rproduct->slug]) }}">
                                            <img src="{{ asset('/assets/images/product/second-pic') }}/{{ $rproduct->image }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{ route('shop.product.detail', ['slug'=>$rproduct->slug]) }}" class="font-default">
                                            <h5>{{ $rproduct->name }}</h5>
                                        </a>
                                        <div class="listing-content">
                                            <span class="font-light">{{ $rproduct->category->name }}</span>
                                            <p class="font-light">{{ \Illuminate\Support\Str::limit($rproduct->description, 50, $end='...') }}</p>
                                        </div>
                                        <h3 class="theme-color">Rp. {{ number_format($rproduct->price, 0, ' ', '.') }}</h3>
