                                        ...
                                        <ul class="category-list">
                                            ...
                                            <li>
                                                ...
                                                <input class="checkbox_animated check-it" id="br{{ $brand->id }}" name="brands"
                                                    ...
                                                    <p class="font-light">({{ $brand->product->count() }})</p>
                                                </div>
                                            </li>
                                            @endforeach
                            ...
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="front">
                                        <a href="{{ route('shop.product.detail',['slug'=>$product->slug]) }}">
                                            <img src="assets/images/product/main-pic/{{ $product->image }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="{{ route('shop.product.detail',['slug'=>$product->slug]) }}">
                                            <img src="assets/images/product/second-pic{{ $product->image }}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    @if (Route::has('login'))
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{ route('shop.product.detail',['slug'=>$product->slug]) }}" class="font-default">
                                            <h5 class="ms-0">{{ $product->name }}</h5>
                                        </a>
                                        <div class="listing-content">
                                            <span class="font-light">{{ $product->category->name }}</span>
                                            <p class="font-light">{{ \Illuminate\Support\Str::limit($product->description, 50, $end='...') }}</p>
                                        </div>
                                        <h3 class="theme-color text-sm">Rp.{{ number_format($product->price, 0, ' ', '.') }}</h3>
