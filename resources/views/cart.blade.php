                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('shop.product.detail',['slug'=>$item->model->slug]) }}">
                                            <img src="{{ asset('/assets/images/product/main-pic') }}/{{ $item->model->image }}" class="blur-up lazyloaded"
                                                alt="{{ $item->model->name }}">
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{ route('shop.product.detail',['slug'=>$item->model->slug]) }}">{{ $item->model->name }}</a>
                                    ...
                                    <td>
                                        <div class="qty-box">
                                            <div class="input-group"><input type="number" name="quantity" data-rowid="{{ $item->rowId }}" onchange="updateQuantity(this)" class="form-control input-number" value="{{ $item->qty }}">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
            ...
            @else
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h5>Add item to your cart now.</h5>
