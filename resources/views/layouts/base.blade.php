                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            @else
                                                <li>
                                                    <a href="{{ route('admin.manage') }}" class="nav-link menu-title">Manage</a>
                                                </li>
                                            @endif
                                            @endauth
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +62 851-6160-2149</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Jungke, Karanganyar, Karanganyar,
                                            Jawa Tengah, Indonesia</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> agungpermadi.solo2007@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{ route('shop.index',['categories'=>1]) }}" class="font-dark">Latest Laptops</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('shop.index',['categories'=>2]) }}" class="font-dark">Latest Computers</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('shop.index',['categories'=>3]) }}" class="font-dark">Latest Accessories</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('shop.index',['categories'=>4]) }}" class="font-dark">Latest Mobiles</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('shop.index',['categories'=>5]) }}" class="font-dark">Latest Softwares</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul>
                                    ...
                                    @if (Route::has('login'))
                                        @auth
                                            ...
                                            @else
                                                <li>
                                                    <a href="{{ route('admin.manage') }}" class="font-dark">Manage Product</a>
                                                </li>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 mr-lg-5 font-dark">© 2023, Agung.</p>
                    </div>
                </div>
            </div>
        </div>
